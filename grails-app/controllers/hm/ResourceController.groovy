...
class ResourceController{
    ...
    def web(){
        String uri = request.requestURI-request.contextPath
        println "请求Web资源路径：$uri"
        webResourceHandler.handleRequest(request,response,servletContext,uri)
    }
    
    def file(){
        String fileuri = request.requestURI-request.contextPath-'/file/'
 ...
 */
    ...
    class MyResourceHttpRequestHandler extends WebContentGenerator{
        // Servlet 3.1 setContentLengthLong(long) available?
         ...
         static  Log logger = LogFactory.getLog(ResourceHttpRequestHandler.class)
    
    
          List<Resource> locations = new ArrayList<Resource>(4)
    
//          List<ResourceResolver> resourceResolvers = new ArrayList<ResourceResolver>(4)
          List<ResourceResolver> resourceResolvers
    
          List<ResourceTransformer> resourceTransformers = new ArrayList<ResourceTransformer>(4)
         ...
         * @see org.springframework.web.accept.ServletPathExtensionContentNegotiationStrategy
...
//            String path = (String) request.getAttribute(HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE)
         ...
         * {@link #getMediaType(HttpServletRequest, org.springframework.core.io.Resource)} instead.
         */
        @Deprecated
